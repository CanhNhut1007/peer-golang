...
func (t *MedicalRecord) createMedicalRecord(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	fmt.Println("Arg0:" + uuid )
	fmt.Println("Arg1:" + args[0])
	fmt.Println("Arg2:" + args[1])
	fmt.Println("Arg3:" + args[2])
	fmt.Println("Arg4:" + args[3])
	fmt.Println("Arg5:" + args[4])
	// Set args for the created record
	var medicalRecord = MedicalRecord{PersonalNumber: uuid, Firstname: args[1], Lastname: args[2], Gender: args[3], Address: args[4], ContactPerson:args[5]}
